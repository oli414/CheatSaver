...
var BooleanOptions = ["disableVandalism", "disableLittering", "disablePlantAging", "disableRideValueAging", "disableAllBreakdowns", "disableBrakesFailure", "freezeWeather", "disableClearanceChecks", "buildInPauseMode", "sandboxMode", "neverendingMarketing", "ignoreRideIntensity", "ignoreResearchStatus", "disableSupportLimits", "disableTrainLengthLimit", "fastLiftHill", "enableChainLiftOnAllTrack", "enableAllDrawableTrackPieces", "showAllOperatingModes", "allowArbitraryRideTypeChanges", "allowTrackPlaceInvalidHeights", "showVehiclesFromOtherTrackTypes"];
...
function getDefaultSetup() {
    var currentSettings = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
function main() {
    ...
    var window = new Oui.Window("cheat_saver", "Cheat Saver");
    window.setColors(19);
    window.setWidth(280);
